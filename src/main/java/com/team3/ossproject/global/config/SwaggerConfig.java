...
import com.team3.ossproject.global.annotation.ApiErrorCodeExample;
...
import com.team3.ossproject.global.dto.ErrorResponse;
...
public class SwaggerConfig {
	...
	public OpenAPI openAPI() {
		Info info = new Info()
			.title("Time To-Do API Document")
			.version("1.0")
			.description(
				"Welcome! This API document explains how to use Time To-Do API.\n")
