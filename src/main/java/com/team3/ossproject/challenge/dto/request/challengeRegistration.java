...
public class challengeRegistration {
    ...
    @Builder
    public challengeRegistration(Long challengeId, String title, String description, LocalDate startDate, Integer duration, String status, LocalDate createdAt, LocalDate finishedAt, Integer remainingDays) {
    ...
    public static challengeRegistration from(Challenge challenge) {
        return challengeRegistration.builder()
